...
gem 'bugsnag'                     # Errors management         https://bugsnag.com

gem 'uglifier', '>= 1.3.0'        # JS compilation            https://github.com/lautis/uglifier
gem 'sass-rails', '~> 4.0.0'
gem 'coffee-rails', '~> 4.0.0'
gem 'jquery-rails'
gem 'modernizr-rails'             # Modernizr                 https://github.com/russfrisch/modernizr-rails
gem 'jbuilder'                    # JSON creation             https://github.com/rails/jbuilder
