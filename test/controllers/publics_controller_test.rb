...
class PublicsControllerTest < ActionController::TestCase
  ...
  test "should create public" do
    assert_difference('Public.count') do
      post :create, public: { age_maximum: @public.age_maximum, age_minimum: @public.age_minimum, professional: @public.professional }
    end
  ...
  test "should update public" do
    patch :update, id: @public, public: { age_maximum: @public.age_maximum, age_minimum: @public.age_minimum, professional: @public.professional }
    assert_redirected_to public_path(assigns(:public))
  end
