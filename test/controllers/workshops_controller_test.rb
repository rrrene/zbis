...
class WorkshopsControllerTest < ActionController::TestCase
  ...
  test "should create workshop" do
    assert_difference('Workshop.count') do
      post :create, workshop: { description: @workshop.description, duration: @workshop.duration, name: @workshop.name, plan: @workshop.plan, price: @workshop.price }
    end
  ...
  test "should update workshop" do
    patch :update, id: @workshop, workshop: { description: @workshop.description, duration: @workshop.duration, name: @workshop.name, plan: @workshop.plan, price: @workshop.price }
    assert_redirected_to workshop_path(assigns(:workshop))
  end
